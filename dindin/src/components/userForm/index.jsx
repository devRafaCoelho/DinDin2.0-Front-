...
export default function UserForm({ setUserFormBoolean, userData, setUserData, getUser }) {
  const {
    register,
    handleSubmit,
    setValue,
  ...
  return (
    <FormBox onSubmit={handleSubmit(onSubmit, (error) => console.log(error))} textAlign="left" component="form" blur="true">
      <TextBox>
      ...
      <Grid container spacing={4}>
        ...
        <DefaultTextField inputName="email" text="E-mail" register={register} errors={errors} placeHolderText="seu E-mail" />
        ...
        <DefaultTextField inputName="newPassword" text="Nova Senha" register={register} errors={errors} placeHolderText="sua Nova Senha" passwordInput={true} />
        <DefaultTextField inputName="confirmPassword" text="Confirme a Senha" register={register} errors={errors} placeHolderText="sua Nova Senha" passwordInput={true} />
      </Grid>
